...
object ArticleRepository {
    ...
    fun findBy(id: Long): Article? = id.createDummyArticle // null for testing 404 not found
    ...
    private val Long.dummyArticleBlocks: Set<ArticleBlock> by lazy {
        ...
        val secondVideoBlock = VideoBlock(
            type = VideoBlockType.YOUTUBE,
            url = "https://youtu.be/myvideo/second",
            sortIndex = 10
        )
        ...
        val thirdVideoBlock = VideoBlock(
            type = VideoBlockType.YOUTUBE,
            url = "https://youtu.be/myvideo/third",
            sortIndex = 1
        )

        setOf(textBlock, imageBlock, secondTextBlock, galleryBlock, thirdTextBlock, videoBlock, thirdVideoBlock, secondVideoBlock)
    }
